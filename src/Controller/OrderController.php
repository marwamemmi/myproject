...
class OrderController extends AbstractController
{
     ...
     */
    public function valider(PlatRepository $productsRepository, SessionInterface $session , PanierRepository $panierRepository , OrderRepository $orderrepository , MailerInterface $mailer, FlashyNotifier $flashy)
    {   $total=0;
...
//
        ...
        $email = (new Email())
            ...
            <p class="block">
                ...
                Vous pouvez annuler votre commande seulement dans les 2 jours qui suivent
            </p>
        </div>');
...
//        $flashy->success('Event created!', 'http://your-awesome-link.com');
     ...
     */
    public function Affichefront2(PanierRepository $repository){
        $userr=$this->getUser()->getUsername();
        $panier=$repository->findByclient($userr);
